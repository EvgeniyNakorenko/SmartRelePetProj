...
//
//class SendServerSettingsMode4UseCase {
//    suspend fun execute(sendServerSettingsMode4DTO: SendServerSettingsMode4DTO): Result<StatusRegServer> {
...
//                val jsonData = Json.encodeToString(sendServerSettingsMode4DTO)
//
    ...
    suspend fun execute(sendServerSettingsMode4DTO: SendServerSettingsMode4DTO): Result<StatusRegServer> {
        return withContext(Dispatchers.IO) {
            try {
                ...
                val response = apiService.sendSettingsMode4(sendServerSettingsMode4DTO)
