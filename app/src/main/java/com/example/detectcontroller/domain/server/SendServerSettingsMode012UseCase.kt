...
//
//class SendServerSettingsMode012UseCase {
//    suspend fun execute(sendServerSettingsMode012DTO: SendServerSettingsMode012DTO): Result<StatusRegServer> {
...
//                val jsonData = Json.encodeToString(sendServerSettingsMode012DTO)
//
    ...
    suspend fun execute(sendServerSettingsMode012DTO: SendServerSettingsMode012DTO): Result<StatusRegServer> {
        return withContext(Dispatchers.IO) {
            try {
                ...
                val response = apiService.sendSettingsMode012(sendServerSettingsMode012DTO)
